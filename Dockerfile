...
RUN R -e "install.packages(c('lubridate', 'purrr', 'httr', 'aws.s3', 'glue', 'knitr', 'tidyr', 'dplyr', 'scales', 'config', 'pagedown', 'jsonlite', 'rmarkdown', 'kableExtra', 'plumber', 'box'), repos='https://cloud.r-project.org/')"
