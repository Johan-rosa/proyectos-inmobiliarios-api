...
output:
  html_document:
    ...
    theme:
      version: 5
params:
  firebase_id: "V9glC0nD8qMdNZhJgtOX"
---
...
:::{#header-left}
<spam class="fs-3 fw-semibold">Proyecto  `r plan_data$proyect`, unidad `r plan_data$unit` </spam>
...
<span class="cf-content fw-bold">`r plan_data$currency` `r comma(plan_data$price, 0.1)`</span>
:::
...
firma_reserva_tbl <- firma_reserva_tbl |>
  mutate(`%` = reservation_signature_percent)
